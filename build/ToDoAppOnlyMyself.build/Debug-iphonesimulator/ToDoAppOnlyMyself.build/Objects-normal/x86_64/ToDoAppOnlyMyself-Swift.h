...
#ifndef TODOAPPONLYMYSELF_SWIFT_H
#define TODOAPPONLYMYSELF_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="ToDoAppOnlyMyself",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC17ToDoAppOnlyMyself11AppDelegate")
...
SWIFT_CLASS("_TtC17ToDoAppOnlyMyself13SceneDelegate")
...
SWIFT_CLASS_NAMED("ToDoListItem")
...
@interface ToDoListItem (SWIFT_EXTENSION(ToDoAppOnlyMyself))
...
SWIFT_CLASS("_TtC17ToDoAppOnlyMyself14ViewController")
